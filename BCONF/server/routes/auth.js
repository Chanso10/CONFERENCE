...
const serializeUser = (row) => {
    return {
        ...
        email: row.email,
        role: row.role,
        isAttendee: row.is_attendee === true,
    };
};
...
const getRegistrationPayload = (body = {}) => {
    ...
    const registrationType = body.registrationType === "attendee" ? "attendee" : "participant";
    const isAttendee = registrationType === "attendee" || body.isAttendee === true || body.isAttendee === "true";
